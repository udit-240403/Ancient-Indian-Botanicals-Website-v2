...
export const BOTANICAL_PRODUCTS: BotanicalProduct[] = [
  ...
  },
  {
    id: 'aib-003',
    slug: 'sandalwood-oil',
    name: 'Sandalwood Oil & Aroma Grades',
    botanicalName: 'Santalum album / aroma profile by offered grade',
    category: 'essential-oils',
    subFamily: 'Wood & resin oils',
    badgeNumber: 'AIB-003',
    description: 'Natural sandalwood oil and sandalwood-inspired aroma routes are identified separately. Botanical origin, composition, legal sourcing evidence and analytical requirements are confirmed for the offered grade.',
    extractionMethod: 'Distillation or aroma-composition route confirmed by grade',
    availableForms: ['Natural Essential Oil — subject to verified availability', 'Clearly identified Aroma Accord'],
    harvestOrigin: 'Origin confirmed against the offered grade',
    image: '/assets/images/hero-botanical-still-life.png',
    specifications: {
      appearance: 'Pale yellow to clear viscous liquid',
      aromaProfile: 'Deep, creamy, sweet woody balsamic with extraordinary tenacity',
      activeMarkers: 'Santalol range and test method confirmed for natural-oil lots where applicable',
  ...
  },
  {
    ...
    badgeNumber: 'AIB-004',
    description: 'Basil essential-oil routes selected around botanical identity, chemotype, aroma profile, application and analytical requirements. Tulsi grades remain separately identified in the complete catalogue.',
