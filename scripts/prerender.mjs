...
const pages = [
  ...
  { path: '/about', title: 'About Ancient Indian Botanicals | Indian Sourcing House', description: 'Meet an incorporated and GST-registered Indian sourcing house supporting botanical, aromatic and food-ingredient buyers through specification-led coordination.', eyebrow: 'You build the brand · We organise the work behind it', heading: 'Your trust is our greatest profit', copy: 'Guided by Vasudhaiva Kutumbakam—the world is one family—we coordinate suitable Indian sourcing routes, samples, available lot documents, brand-ready packaging and export preparation around the approved buyer brief.' },
...
const organization = {
  ...
  description: 'Incorporated and GST-registered Indian B2B sourcing company for botanical, aromatic and food ingredients.',
};
