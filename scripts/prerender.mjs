...
const pages = [
  ...
  { path: '/packaging', title: 'Botanical Export Packaging Options | Ancient Indian Botanicals', description: 'Review sample, oil, dry botanical, bulk-liquid and selected private-label packaging routes for botanical exports.', eyebrow: 'Packaging architecture', heading: 'From evaluation sample to commercial bulk', copy: 'Packaging routes are reviewed around product compatibility, fill quantity, destination, closure and transport requirements.' },
  ...
  { path: '/about', title: 'About Ancient Indian Botanicals | Indian Sourcing House', description: 'Ancient Indian Botanicals connects international buyer specifications with suitable Indian botanical and aromatic supply routes.', eyebrow: 'Sourcing-house provenance', heading: 'A modern botanical sourcing house with an Indian origin advantage', copy: 'We clarify the requirement, match suitable material routes, coordinate available documentation, confirm packaging and support export execution.' },
