...
const faqs = JSON.parse(await readFile(path.join(ROOT, 'src/data/faq.json'), 'utf8'));
...
const pages = [
  ...
  { path: '/faq', title: 'Botanical Sourcing FAQ | Ancient Indian Botanicals', description: 'Answers about MOQ, COA and specification documents, payment terms, Incoterms, private-label packaging and verified company registrations.', eyebrow: 'Buyer due-diligence FAQ', heading: 'Clear answers before you send a sourcing brief', copy: 'Review registration status, MOQ, lot documents, payment routes, Incoterms and private-label coordination before starting an enquiry.' },
  { path: '/about', title: 'About Ancient Indian Botanicals | Indian Sourcing House', description: 'Meet an Indian sourcing house established in 2026 and registered under GST and Udyam, supporting specification-led botanical and food-ingredient coordination.', eyebrow: 'You build the brand · We organise the work behind it', heading: 'Your trust is our greatest profit', copy: 'Guided by Vasudhaiva Kutumbakam—the world is one family—we coordinate suitable Indian sourcing routes, samples, available lot documents, brand-ready packaging and export preparation around the approved buyer brief.' },
...
const organization = {
  ...
  description: 'Indian B2B sourcing company incorporated in 2026 and registered under GST and Udyam.',
  foundingDate: '2026',
  sameAs: ['https://www.linkedin.com/in/ancient-indian-botanicals-undefined-b48450430'],
};
